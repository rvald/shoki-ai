...
soap_note_tool = FunctionTool(generate_soap_note)
available_tools = {soap_note_tool.name: soap_note_tool}
...
async def list_tools() -> list[mcp_types.Tool]:
  ...
  mcp_tool_schema_audit = adk_to_mcp_tool_type(soap_note_tool)
